...
export default function HistoryPage() {
  return (
    <main className="min-h-screen bg-[#f8fafc] px-6 py-10 text-[#0f1729]">
        ...
        <div className="mt-10 space-y-4">
          {pickHistory.map((pick) => (
            <Link
              ...
              className="grid gap-4 rounded-md border border-[#e2e8f0] bg-white p-5 shadow-sm transition hover:-translate-y-1 hover:shadow-xl md:grid-cols-[180px_1fr_auto] md:items-center"
            >
